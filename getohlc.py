...
download_bybit_data_to_csv('BTCUSD','15',time_a_day_ago(),'bitcoin15minute.csv')

#schedule the function to run every 15 minutes

schedule.every(10).seconds.do(download_bybit_data_to_csv,'BTCUSD','15',time_a_day_ago(),'bitcoin15minute.csv')
